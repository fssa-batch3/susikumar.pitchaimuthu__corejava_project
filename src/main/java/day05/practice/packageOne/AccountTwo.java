...
public class AccountTwo {
	 ...
	 private String accNo;
	    ...
	    // Constructor
	    public AccountTwo(String accNo, double balance) {
	        this.accNo = accNo;
	...
	// Interface
	 abstract class ATM {
	    ...
	    abstract boolean deposit(Account account, double amount);
	  abstract  boolean withdraw(Account account, double amount) throws Exception;
	 abstract   double getBalance(Account account); // Pass the Account object as a parameter
	}
